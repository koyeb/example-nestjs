...
4. To let Koyeb know how to launch the application, add `yarn run start:prod` as the run command
5. Update the build command field with `yarn run build`
6. Then, give your App a name, i.e `nestjs-on-koyeb`, and click **Create App.**
